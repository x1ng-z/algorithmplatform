...
public class AppThreadconfig {
    ...
    public ExecutorService executeThreadPool(){
         ...
         * */
        ExecutorService pool = new ThreadPoolExecutor(30/* 线程池维护的线程数量，即使其中有闲置线程*/, 2000/*线程池能容纳的最大线程数量*/,
     ...
     * 请求中的控制其执行程序
     * */
    @Bean("msgComstorThreadPool")
    public ExecutorService msgComstorThreadPool(){
        ThreadFactory namedThreadFactory = new ThreadFactoryBuilder()
                .setNameFormat("msg-pool-%d").setDaemon(true).build();
